...
<?php echo form_password(array('name'=>'currentpassword','id'=>'password','class'=>'form-control','autofocus'=>'autofocus','value'=>set_value('currentpassword')));?>
...
<?php echo form_error('confirmpassword',"<div style='color:red'>","</div>");?>
   ...
   <div class="form-row">             
                <div class="col-md-6">
 <?php echo form_submit(array('name'=>'chnagepwd','value'=>'Change','class'=>'btn btn-primary btn-block')); ?>
</div>
</div>
</div>
 <?php echo form_close();?>
